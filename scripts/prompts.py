...
This function is used to ask human for help当你缺少必要的信息生成下一步操作时. "question" is the question you want to ask and must be wrapped with double quotation marks. A simple use case can be ask_human("What is the name of this app?"), which asks human for the name of the app shown on the smartphone screen.
